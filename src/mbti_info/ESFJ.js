...
function ESFJ() {
    ...
    return (
        <div>
            ...
            <h4>ESFJs have a talent for making the people in their lives feel supported, cared for, and secure.</h4>
            <br />
            ...
            <h4>ESFJs have a clear moral compass – and it can be nothing short of baffling to them when other people’s actions don’t align with it.</h4>
            ...
            <h4>People with the ESFJ personality type rarely miss a birthday or holiday. Devoted to their relationships, they commit even the smallest details of their friends’ and loved ones’ lives to memory.</h4>
