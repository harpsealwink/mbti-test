...
function ENFJ() {
    ...
    return (
        <div>
            ...
            <br /><br />
            <div className="blue-txt">ENFJs possess the unique ability to remain hopeful in the face of difficulties, always remembering that there is something to be grateful for.</div>
            <br />
            ...
            <br /><br />
            <div className="blue-txt">ENFJ personalities possess an innate sense of justice and an unwavering commitment to standing up against what they perceive as wrong.</div>
            <br />
            ...
            <div className="blue-txt">ENFJ personalities are genuine, caring people who talk the talk and walk the walk. Nothing makes them happier than motivating others to do what’s right.</div>
            <br />
