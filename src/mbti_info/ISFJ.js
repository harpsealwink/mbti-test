...
function ISFJ() {
    ...
    return (
        <div>
            ...
            <h4>ISFJs are true altruists, meeting kindness with kindness-in-excess and engaging with the work and people they believe in with enthusiasm and generosity.</h4>
            <br />
            ...
            <h4>A notable ISFJ weakness is that they often find change difficult – particularly when it’s sudden or involves unfamiliar territory. In fact, they are the most likely personality type to feel stressed out by last minute changes.</h4>
            <br />
