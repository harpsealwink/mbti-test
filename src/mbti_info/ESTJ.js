...
function ESTJ() {
    ...
    return (
        <div>
            ...
            <br /><br />
            <div className="blue-txt">ESTJs are classic images of the model citizen: they help their neighbors, uphold the law, and try to make sure that everyone participates in the communities and organizations that they hold so dear.</div>
            <br />
            ...
            <br /><br />
            <div className="blue-txt">People with the ESTJ personality type are dedicated individuals who pride themselves on always finishing what they start, rendering them reliable and trustworthy.</div>
            <br />
