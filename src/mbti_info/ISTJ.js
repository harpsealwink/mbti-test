...
function ISTJ() {
    ...
    return (
        <div>
            ...
            <h4>True to their methodical nature, ISTJs often steer clear of impulsive behaviors, instead favoring careful deliberation when it comes to decision-making of any kind.</h4>
            <br />
            ...
            <h4>In a world where many people shirk their responsibilities or say what they think others want to hear, ISTJs stand out as dedicated, responsible, and honest.</h4>
