...
function ENTP() {
    ...
    return (
        <div>
            ...
            <h4>ENTP personalities are the ultimate devil’s advocates, thriving on the process of shredding people’s arguments to pieces. Sometimes they even rebel against their own beliefs by arguing the opposing viewpoint – just to see how the world looks from the other side.</h4>
            <br />
            ...
            <h4>For many people with the ENTP personality type, one of life’s greatest challenges is to translate their wide-ranging intellectual energy into real-world achievements and contributions.</h4>
            ...
            <h4>Many ENTPs find that a more compassionate approach is worth exploring as they strive to build solid relationships.</h4>
