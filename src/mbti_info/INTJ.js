...
function INTJ() {
    ...
    return (
        <div>
            ...
            <h4>People with the INTJ personality type, independent to the core, want to shake off other people’s expectations and pursue their own ideas.</h4>
            ...
            <h4>INTJs don’t just learn new things for show – they genuinely enjoy expanding the limits of their knowledge.</h4>
            ...
            <h4>At times, people with the INTJ personality type may wonder whether dealing with other people is even worth the frustration.</h4>
